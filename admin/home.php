    ...
    <div class="wrapper">
        <div class="wrapper1">
            <main class="container">
                <nav class="offcanvas offcanvas-start show" tabindex="-1" id="offcanvas" data-bs-keyboard="false"
                    ...
                    <div class="offcanvas-body px-0">
                        ...
                        <li class="mb-1">
                                ...
                                <div class="collapse show" id="users-collapse" style="">
                                    <ul class="btn-toggle-nav list-unstyled fw-normal pb-1 small">
                                        <li><a href="#add_users-content" class="rounded">Add Users</a></li>
                                        <li><a href="#edit_users-content" class="rounded">Edit users</a></li>
                                    </ul>
                                </div>
                            </li>
                            <li class="mb-1">
                ...
                <div class="main">
                <div id="add_users-content" class="row">
                        <div class="add-containerr">
                            <h2 id="title">Add users
                                <hr>
                            </h2>
                            <?php
                       
                        include('../user-reg/reg.php');
                        ?>
                        </div>
                    </div>
                    <div id="edit_users-content" class="row">
