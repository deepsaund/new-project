        ...
        if ($result->num_rows > 0) {
            ...
            while ($row = $result->fetch_assoc()) {
                ...
                echo '<td class="action-links">
                        <a href="edit_course.php?course_id=' . $row["course_id"] . '"><i class="fa-regular fa-pen-to-square fa-sm"></i></a>
                        <a href="delete_course.php?course_id=' . $row["course_id"] . '" onclick="return confirm(\'Are you sure you want to delete this course?\')"><i class="fa-solid fa-trash fa-sm"></i></a>
                      </td>';
                echo '</tr>';
            }
            echo '</tbody>';
