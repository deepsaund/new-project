...
if (isset($_SESSION['message'])) {
    ...
    // Unset the message to prevent it from being displayed again
    unset($_SESSION['message']);

    // Use JavaScript to display the message in an alert box
				...
				<div class="form first">
					<div class="details personal">
						...
						<div class="fields">
							...
							<div class="input-field">
								...
								<input type="date" placeholder="Enter birth date" name="date_of_birth" value=""
									required>
							</div>
					...
					<div class="details ID">
						...
						<div class="fields">
							...
							<div class="input-field">
								<label>Photo</label>
								<input type="file" name="photo" id="input_import_file" class="form-control file-input">
